													...
													<div  style=" word-break:break-all; width: 300px;"class="row h-50 w-100 d-block d-flex pt-3 " >
															<table class="justify-content-center d-inline-block w-100">
																...
																<tr>
																	...
																	<c:if test="${(listOne.s_userId).equals(std.user_Id) }">
																		<textarea id="r_content" name="r_content" onkeydown="resize(this)" onkeyup="resize(this)" cols="100" style="background:#fff;">${reply.r_content}</textarea>
																		<input type="button"class="leaderBtn d-inline-block"  value="답변하기" onclick="leaderRe(this)" />
																	</c:if>
																	</td>
																</tr>
															</table>
