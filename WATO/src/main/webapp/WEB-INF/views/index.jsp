        ...
        <div class="container"><a href="index.jsp" class="navbar-brand home"><img src="/images/studyus.png" alt="Obaju logo" class="d-none d-md-inline-block"><img src="/images/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none"><span class="sr-only">Obaju - go to homepage</span></a>
            ...
            <div id="navigation" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link">학생<b class="caret"></b></a>
                    ...
                    <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link">그룹장<b class="caret"></b></a>
                        <ul class="dropdown-menu megamenu">
                            <li>
                                <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="banner"><a href="#"><img src="/images/banner2.jpg" alt="" class="img img-fluid"></a></div>
                    ...
                    <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="dropdown-toggle nav-link">자유게시판</a>
                </ul>
    ...
    <div id="content">
        ...
        <div id="icon" class="box text-center mt-0 mb-0">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2">
                        <a href="blog.jsp"><img src="/images/c.png"><br/><span class="text">c언어</span></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="blog.jsp"><img src="/images/cpp.png"><br/><span class="text">c++언어</span></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="blog.jsp"><img src="/images/java.png"><br/><span class="text">자바</span></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="blog.jsp"><img src="/images/javascript.png"><br/><span class="text">자바스크립트</span></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="blog.jsp"><img src="/images/python.png"><br/><span class="text">파이썬</span></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="blog.jsp"><img src="/images/android.png"><br/><span class="text">안드로이드</span></a>
                    </div>
                </div> 
            </div>
        </div>
                ...
                <div class="product-slider owl-carousel owl-theme">
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
                                <div class="flipper">
                                    <div class="front"><a href="detail.jsp"><img src="/images/cstudy-1.png" alt="" class="img-fluid"></a></div>
                                    <div class="back"><a href="detail.jsp"><img src="/images/cstudy-1.png" alt="" class="img-fluid"></a></div>
                                </div>
                            </div><a href="detail.jsp" class="invisible"><img src="/images/cstudy-1.png" alt="" class="img-fluid"></a>
                            <div class="text">
                                <h3><a href="detail.jsp">C언어 스터디 !!</a></h3>
                                <p class="price">
                                    <del></del>참가비 5천원
                                </p>
                            </div> 
                            <!-- /.text-->
                            <div class="ribbon sale mb-0">
                    ...
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
                                <div class="flipper">
                                    <div class="front"><a href="detail.jsp"><img src="/images/cppstudy_1.png" alt="" class="img-fluid"></a></div>
                                    <div class="back"><a href="detail.jsp"><img src="/images/cppstudy_1.png" alt="" class="img-fluid"></a></div>
                                </div>
                            </div><a href="detail.jsp" class="invisible"><img src="/images/cppstudy_1.png" alt="" class="img-fluid"></a>
                            <div class="text">
                                <h3><a href="detail.jsp">C++ 스터디</a></h3>
                                <p class="price">
                                    <del>만원</del> -> 무료
                                </p>
                            </div>
                    ...
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
                                <div class="flipper">
                                    <div class="front"><a href="detail.jsp"><img src="/images/javascriptstudy_1.png" alt="" class="img-fluid"></a></div>
                                    <div class="back"><a href="detail.jsp"><img src="/images/javascriptstudy_1.png" alt="" class="img-fluid"></a></div>
                                </div>
                            </div><a href="detail.jsp" class="invisible"><img src="/images/javascriptstudy_1.png" alt="" class="img-fluid"></a>
                            <div class="text">
                                <h3><a href="detail.jsp">자바스크립트</a></h3>
                                <p class="price">
                                    <del></del>참가비 3천원
                                </p>
                            </div>
                    ...
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
                                <div class="flipper">
                                    <div class="front"><a href="detail.jsp"><img src="/images/javastudy_1.png" alt="" class="img-fluid"></a></div>
                                    <div class="back"><a href="detail.jsp"><img src="/images/javastudy_1.png" alt="" class="img-fluid"></a></div>
                                </div>
                            </div><a href="detail.jsp" class="invisible"><img src="/images/javastudy_1.png" alt="" class="img-fluid"></a>
                            <div class="text">
                                <h3><a href="detail.jsp">자바스터디</a></h3>
                                <p class="price">
                                    <del></del>5천원
                                </p>
                            </div>
                    ...
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
                                <div class="flipper">
                                    <div class="front"><a href="detail.jsp"><img src="/images/pythonstudy_1.png" alt="" class="img-fluid"></a></div>
                                    <div class="back"><a href="detail.jsp"><img src="/images/pythonstudy_1.png" alt="" class="img-fluid"></a></div>
                                </div>
                            </div><a href="detail.jsp" class="invisible"><img src="/images/pythonstudy_1.png" alt="" class="img-fluid"></a>
                            <div class="text">
                                <h3><a href="detail.jsp">파이썬 스터디</a></h3>
                                <p class="price">
                                    <del></del>6천원
                                </p>
                            </div>
                    ...
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
                                <div class="flipper">
                                    <div class="front"><a href="detail.jsp"><img src="/images/visualbasicstudy_1.png" alt="" class="img-fluid"></a></div>
                                    <div class="back"><a href="detail.jsp"><img src="/images/visualbasicstudy_1.png" alt="" class="img-fluid"></a></div>
                                </div>
                            </div><a href="detail.jsp" class="invisible"><img src="/images/visualbasicstudy_1.png" alt="" class="img-fluid"></a>
                            <div class="text">
                                <h3><a href="detail.jsp">비주얼 베이직</a></h3>
                                <p class="price">
                                    <del></del>8천원
                                </p>
                            </div>
                    ...
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
                                <div class="flipper">
                                    <div class="front"><a href="detail.jsp"><img src="/images/dbstudy-1.png" alt="" class="img-fluid"></a></div>
                                    <div class="back"><a href="detail.jsp"><img src="/images/dbstudy-1.png" alt="" class="img-fluid"></a></div>
                                </div>
                            </div><a href="detail.jsp" class="invisible"><img src="/images/dbstudy-1.png" alt="" class="img-fluid"></a>
                            <div class="text">
                                <h3><a href="detail.jsp">데이터베이스</a></h3>
                                <p class="price">
                                    <del></del>무료
                                </p>
                            </div>
                    ...
                    <div class="item">
                        <div class="product">
                            <div class="flip-container">
                                <div class="flipper">
                                    <div class="front"><a href="detail.jsp"><img src="/images/jquerystudy_1.png" alt="" class="img-fluid"></a></div>
                                    <div class="back"><a href="detail.jsp"><img src="/images/jquerystudy_1.png" alt="" class="img-fluid"></a></div>
                                </div>
                            </div><a href="detail.jsp" class="invisible"><img src="/images/jquerystudy_1.png" alt="" class="img-fluid"></a>
                            <div class="text">
                                <h3><a href="detail.jsp">J-Query스터디</a></h3>
                                <p class="price">
                                    <del></del>무료
                                </p>
                            </div>
