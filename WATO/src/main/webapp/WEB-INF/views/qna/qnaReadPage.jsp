...
<section>
    <form role="form" method="post" autocomplete="off">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" id="bno" name="bno" class="form-control" value="${getQnaRead.QNA_BNO}" readonly="readonly" />
            </div>
        </div>
        <div class="form-group">
            <label for="title" class="col-sm-2 control-label">글 제목</label>
            <div class="col-sm-12">
                <input type="text" id="title" name="title" class="form-control" value="${getQnaRead.QNA_TITLE}" readonly="readonly"  />
            </div>
        </div>
        <div class="form-group">
            <label for="content" class="col-sm-2 control-label">글 내용</label>
            <div class="col-sm-12">
                <textarea id="content" name="content" class="summernote" readonly="readonly">${getQnaRead.QNA_CONTENT}</textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="writer" class="col-sm-2 control-label">작성자</label>
            <div class="col-sm-12">
                <input type="text" id="writer" name="writer" class="form-control" value="${getQnaRead.QNA_WRITER}" readonly="readonly" />
            </div>
        </div>
        ...
        <div class="form-group" style="border: 1px solid #dbdbdb;">
            ...
            <c:forEach var="file" items="${file}">
                <a href="#" id="fileDown" onclick="fn_fileDown('${file.bno}'); return false;">${file.DBFILE}</a>
            </c:forEach>
            </form>
        </div>
    </form>
        ...
        <c:forEach items="${repList}" var="repList">
            <li>
                <p>
                 ...
                 <textarea name="content" class="form-control" readonly >${repList.QNA_CONTENT}</textarea>
                <div class="form-group">
                    <input type="hidden" name="bno" value="${repList.QNA_BNO}">
                    <input type="hidden" name="rno" value="${repList.QNA_RNO}">
                    <button type="button" onclick="replyUpdate_btn(this)" class="btn btn-warning">수정</button>
                    <button type="button" class="btn btn-danger">
                        <a href="/qna/replyDelete/${getQnaRead.QNA_BNO}/${repList.QNA_RNO}" onclick="replyDelete_btn()">삭제</a></button>
                </div>
            </li>
        </c:forEach>
    </ol>
           ...
           <form role="form" method="post" autocomplete="off">
              <%-- <input type="hidden" id="page" name="page" value="${scri.page}" readonly="readonly" />
               ...
               <div class="form-group">
                   <label for="writer" class="col-sm-2 control-label">작성자</label>
                   <div class="col-sm-10">
                       <input type="text" id="writer1" name="writer" class="form-control" />
                   </div>
               </div>
