    ...
    <section>
        <form role="form" method="post" autocomplete="off">
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input type="text" id="bno" name="BNO" class="form-control" value="${getQnaModify.QNA_BNO}" readonly="readonly" />
                </div>
            </div>
        <div class="form-group">
            <label for="title" class="col-sm-2 control-label">글 제목</label>
            <div class="col-sm-12">
                <input type="text" id="title" name="TITLE" class="form-control" value="${getQnaModify.QNA_TITLE}"  />
            </div>
        </div>
        <div class="form-group">
            <label for="summernote" class="col-sm-2 control-label">글 내용</label>
            <div class="col-sm-12">
                <textarea id="summernote" name="content" class="summernote" >${getQnaModify.QNA_CONTENT}</textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="writer" class="col-sm-2 control-label">작성자</label>
            <div class="col-sm-12">
                <input type="text" id="writer" name="WRITER" class="form-control" value="${getQnaModify.QNA_WRITER}" readonly="readonly" />
            </div>
        </div>
