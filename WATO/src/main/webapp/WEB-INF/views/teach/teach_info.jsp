			        ...
			        <div>
			            <table class="table_main" style="text-align: left;">
			                ...
			                <tr>
			                    ...
			                    <td><input type="text" id="sample3_address" name="Teach_Addr2" value="${teach.teach_Addr2}" placeholder="도로명주소"></td>
			                </tr>
			                <tr>
			                    <th>상세주소 <img src="//img.echosting.cafe24.com/skin/base/common/ico_required_blue.gif"></th>
			                    <td><input type="text" id="sample3_detailAddress" name="Teach_Addr3" value="${teach.teach_Addr3}" placeholder="상세주소"><div id="wrap" style="display:none;border:1px solid;width:500px;height:300px;margin:5px 0;position:relative">
...
// 회원정보 null 파악_____________________________________
	...
	function infoCheck() {
		...
		if(!document.infoForm.Teach_Phone1.value) {
			alert("휴대폰 번호를 입력해주세요.");
			document.infoForm.Teach_Phone1.focus();
			return false;
		}
		
		if(!document.infoForm.Teach_Phone2.value) {
			alert("휴대폰 번호를 입력해주세요.");
			document.infoForm.Teach_Phone2.focus();
			return false;
		}
		
		if(!document.infoForm.Teach_Phone3.value) {
			alert("휴대폰 번호를 입력해주세요.");
			document.infoForm.Teach_Phone3.focus();
			return false;
		}
		...
		if(!document.infoForm.Teach_Addr1.value) {
			alert("우편번호를 입력해주세요.");
			document.infoForm.Teach_Addr1.focus();
			return false;
		}
		
		if(!document.infoForm.Teach_Addr2.value) {
			alert("주소를 입력해주세요.");
			document.infoForm.Teach_Addr2.focus();
			return false;
		}
		
		if(!document.infoForm.Teach_Addr3.value) {
			alert("상세주소를 입력해주세요.");
			document.infoForm.Teach_Addr3.focus();
			return false;
		}
