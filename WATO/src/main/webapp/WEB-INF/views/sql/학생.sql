...
insert into std_info(std_id, std_profile, std_pwd, std_pwd_qs, std_pwd_as, std_gender, std_phone1, std_phone2, std_phone3, std_email, std_addr1, std_addr2, std_addr3)
